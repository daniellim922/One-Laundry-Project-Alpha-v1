...
| Dashboard overview chart aggregates              | `services/dashboard/` (`timesheet-monthly-hours-aggregates.ts`, `expense-monthly-aggregates.ts`, `advance-monthly-repayment-aggregates.ts`, `payroll-monthly-category-aggregates.ts`, `payroll-monthly-grand-total-aggregates.ts`)                                                |
