...
| Term        | Definition                                                                                                                                                                                          | Aliases to avoid                                                                                   |
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| **Expense** | A business **Expense** line: description, amount, optional category, and date. **Expenses** do not allocate to a **Worker** or a **Payroll** run (shop/overhead or general back-office spend only). | Cost (unless finance agrees); implying reimbursement through payroll **Grand Total** without a dedicated model |
