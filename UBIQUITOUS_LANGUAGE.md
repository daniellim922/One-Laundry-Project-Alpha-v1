...
| **Payroll voucher**                  | The frozen calculation snapshot for a **Payroll**: hours, premiums, deductions, CPF, **Advance** recovery, **Subtotal**, **Grand Total**, and copied payout details. **Rest days** remain operator-adjusted on the voucher, while **Public holidays** are a computed snapshot for newly created Draft payrolls derived from the shared **Public holiday calendar**. | Voucher (without "payroll"), payslip                                                                        |
...
| **Gross pay components** (part-time) | **Hourly rate** × **Total hours worked** only. No overtime, no rest day pay, no public holiday pay.                                                                                                                                                                                                                                                                           | Wages (ok colloquially; prefer precise terms in rules)                                                      |
| **Overtime hours**                   | For full-time, hours worked beyond **Minimum working hours** in the period.                                                                                                                                                                                                                                                                                                        | OT                                                                                                          |
| **Rest days worked**                 | The number of rest days (typically Sundays) in the **Pay period** on which the **Worker** actually worked, inferred as the rest-day budget minus days with no timesheet entry (assumed rest days taken off). Editable on **Draft** vouchers for edge cases (e.g., 5-Sunday months).\n| **Rest day pay**                     | Premium pay for **Rest days worked** in the period at **Rest day rate**. This is compensation for working on a day that should have been off, not pay for resting.                                                                                                                                                                                                                                                                                                                  | Weekend pay (only if rest days are literally weekends)                                                      |
