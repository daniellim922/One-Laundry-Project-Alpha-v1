...
| **Historical seed window**      | The deterministic seeded operating history covering monthly payroll, timesheets, and advances from `2025-04` through `2025-12` for all active **Workers**; it contains no built-in seeded **Draft Payrolls**.                                                           | Demo month, sample month                                  |
