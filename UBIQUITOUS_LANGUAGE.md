...
| **Payroll voucher**                  | The frozen calculation snapshot for a **Payroll**: hours, premiums, deductions, CPF, **Advance** recovery, **Total pay**, **Net pay**, and copied payout details. **Rest days** remain operator-adjusted on the voucher, while **Public holidays** are moving toward a computed snapshot derived from the shared **Public holiday calendar**.                          | Voucher (without "payroll"), payslip                                                                        |
