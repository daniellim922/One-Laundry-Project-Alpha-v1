...
type Props = {
    voucher: Pick<
        ...
        "grandTotal" | "subTotal" | "cpf" | "advance"
    >;
};
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:items-end">
                <div className="md:col-span-1">
                    ...
                    <p className="mt-1 text-4xl font-semibold tabular-nums">
                        {formatMoney(voucher.grandTotal)}
                    </p>
                </div>
                <HeroSecondary label="Subtotal" value={voucher.subTotal} />
                <HeroSecondary label="CPF" value={voucher.cpf} />
                <HeroSecondary label="Advance Pay" value={voucher.advance} />
            </div>
        </div>
    );
}
