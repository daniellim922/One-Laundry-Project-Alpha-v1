...
7. Set `AUTH_ADMIN_EMAIL`, `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`, and `SUPABASE_SERVICE_ROLE_KEY` in `.env`.
8. Bootstrap or repair the single admin auth user with `npm run auth:bootstrap-admin`.
